...
namespace SpreadBot.Models.Repository
{
    public class MarketData : IMessage
    {
        ...
        public decimal SpreadPercentage => BidRate.GetValueOrDefault(0) == 0 ? 0 : (AskRate.GetValueOrDefault(0) - BidRate.GetValueOrDefault(0)) / BidRate.GetValueOrDefault(1) * 100; //Formula source = https://www.calculatorsoup.com/calculators/financial/bid-ask-calculator.php
    }
}
